...
function browserExport() {
    ...
    setTimeout(() => {
        ...
        function addFooter(data) {
            doc.setFontSize(8);
            doc.setTextColor(40);
            let str = 'Exported by Toastmasters Timer. Created by Naaji';
            doc.textWithLink(str, data.settings.margin.left, doc.internal.pageSize.height - 30, { url: "https://github.com/naaji-navas" });
        }
